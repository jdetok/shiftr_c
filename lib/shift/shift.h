...
// void chaser(shiftReg *sr, state *st, int num_sr, uint8_t rev, uint8_t lcd); // single bit
void byte_chaser(shiftReg *sr, state *st, int num_sr, uint8_t rev, uint8_t lcd); // byte
// void mode_selector(shiftReg *sr, state *st, uint8_t mode, uint8_t lcd); // call chaser
